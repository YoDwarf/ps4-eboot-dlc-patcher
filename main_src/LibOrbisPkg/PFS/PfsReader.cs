...
namespace LibOrbisPkg.PFS
{
    ...
    public class PfsReader
    {
        ...
        public abstract class Node
        {
            ...
            public string FullNameImage0 => FullName.StartsWith("/uroot") ? "/Image0" + FullName.Substring(6) : FullName;
        }
        /// <summary>
        ...
        public class File : Node
        {
            ...
            public async Task Save(string path, bool decompress = false, Func<long, Task>? bytesCopiedProgress = null)
            {
                ...
                await Save(fs, decompress, bytesCopiedProgress);
            }

            public async Task Save(Stream output, bool decompress = false, Func<long, Task>? bytesCopiedProgress = null)
            {
                ...
                while (sz > 0)
                {
                    ...
                    await output.WriteAsync(buf, 0, toRead);
                    pos += toRead;
                    sz -= toRead;
